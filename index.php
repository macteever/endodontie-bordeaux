  ...
  <div class="container-fluid tmplt-blog">
      <div class="container pt-150 mb-150 block-parallax">
			<div class="row tmplt-projets-title mb-15">
				<h1 class="montserrat fs-72 fw-700 ml-15 mb-10">Les Actus</h1>
			</div>
         ...
         <span class="ml-auto"><b><a href="/actualites">voir tout</a></b></span>
			...
			<div class="row row-templt-projets index-parallax anim-300">
				<div class="col-xl-6 col-lg-6 col-md-12 col-12 index-parallax-child">
					<a class="d-block anim-300" href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
						<img class="tmplt-projet-thumbnail anim-300 index-thumbnail mb-30" src="<?php echo wp_get_attachment_url( get_post_thumbnail_id($post->ID) ); ?>');" alt="Création de site internet Bordeaux Poitiers Webmaster freelance Nicolas Métivier"/>
